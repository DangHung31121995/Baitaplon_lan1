...
// print('idcity: '.$idCity);
     ...
     case 'step2':
           ...
           if(empty($action_POST)){
            ...
            $city_hotel = new city_hotel_model();
            $cityname = $city_hotel->getCity($id_city)->name;
            $hotelname=$city_hotel->getHotel($id_hotel)->name;
            ...
            $types=$roomtype_model->getType($id_hotel);
            ...
            // print($id_hotel.'------'.$startDateTime.'-------'.$endDateTime);
            //test 2,8,9  '
