            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Quản lý ý kiến khách hàng </h3>
                </div><!-- /.box-header -->
                <div class="row">
                 <div class="col-md-4 col-md-push-7">
                 <div class="input-group">
                    <form action="index.php?controller=REVIEWS&action=timkiem" method="post">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <?php 
                      ...
                      <tr id="test">
                        ...
                        <a name="createItem" class="btn btn-danger " href="index.php?controller=REVIEWS&action=delete&id=<?php print $value->id ?>"><i class="fa fa-plus">Xóa </i></a>
