				...
				<form class="" action="?controller=viewbooking&action=step2" method="post">
					...
					<div class="form-row ">
						<div class=" col-md-6">
							...
							<select class="form-control city select_city" id ="select_city" name="select_city">
					...
					<div class="form-row" style="margin-top: 15px">
						...
						<div class="col-md-6">
							...
							<input type="text" class="form-control" name="totalDay" id ="totalDay" disabled/>
						</div>
...
<script type="text/javascript">
	...
	var conceptName = $('.select_city').find(":selected").val();
	console.log('idcity-zz: ',conceptName);
	if(conceptName){
		$.post("View/user/data.php",{id:conceptName},function(data){
				// console.log(data);
			$('.khachsan').html(data);
		});
	}
